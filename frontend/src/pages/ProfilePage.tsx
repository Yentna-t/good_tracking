...
const goalEmoji: Record<ProfileFormValues["goal"], string> = { lose_weight: "🌱", maintain_weight: "⚖️", gain_weight: "⬆️", gain_muscle: "💪" };
...
export function ProfilePage() {
  ...
  return <div className="page-width wellness-page profile-page">
    ...
    <div className="profile-layout"><div className="profile-form-column"><form onSubmit={handleSubmit(onSubmit)} noValidate>
      <section className="form-card"><div className="card-heading"><div className="card-number">01</div><div><h2 className="emoji-label"><EmojiCue symbol="👤" variant="section" /><span>Personal information</span></h2><p>Basic information helps us understand your starting point.</p></div></div><div className="form-grid four-columns">
      ...
      <section className="form-card"><div className="card-heading"><div className="card-number">02</div><div><h2 className="emoji-label"><EmojiCue symbol="🎯" variant="section" /><span>Health goal</span></h2><p>Choose the direction that best matches what you want to achieve.</p></div></div><div className="goal-grid">{goalOptions.map(([value, label, description]) => <label className="goal-option" key={value}><input type="radio" value={value} {...register("goal")} /><span className="goal-radio" /><span><strong className="emoji-label"><EmojiCue symbol={goalEmoji[value]} /><span>{label}</span></strong><small>{description}</small></span></label>)}</div><FieldError message={errors.goal?.message} /></section>
      <section className="form-card"><div className="card-heading"><div className="card-number">03</div><div><h2 className="emoji-label"><EmojiCue symbol="🏃" variant="section" /><span>Daily preferences</span></h2><p>These choices help us tailor future recommendations.</p></div></div><div className="form-grid two-columns">
