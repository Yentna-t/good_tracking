...
export function ProgressPage() {
  ...
  return <div className="page-width progress-page">
    ...
    <div className="charts-grid"><section className="dashboard-card chart-card chart-card-wide"><div className="section-heading"><div><span className="eyebrow">BODY COMPOSITION</span><h2>Weight trend</h2></div><div className="chart-legend"><span><i className="legend-dot" style={{ background: "#2f9e44" }} /> Weight</span><strong>{lastWeight.toFixed(1)} kg</strong></div></div><WeightTrendChart points={chartWeightPoints} /></section><section className="dashboard-card chart-card"><div className="section-heading"><div><span className="eyebrow">CALORIE TRACKING</span><h2>Calorie adherence</h2></div><div className="chart-legend"><span><i className="legend-dot" style={{ background: "#f0a43c" }} /> Daily target</span></div></div><CalorieAdherenceChart values={calorieValues} labels={calorieLabels} /></section><section className="dashboard-card chart-card"><div className="section-heading"><div><span className="eyebrow">MACRO TRACKING</span><h2>Macro adherence</h2></div><div className="chart-legend"><span><i className="legend-dot" style={{ background: "#2f9e44" }} /> P</span><span><i className="legend-dot" style={{ background: "#f0a43c" }} /> C</span><span><i className="legend-dot" style={{ background: "#7c72d8" }} /> F</span></div></div><MacroAdherenceChart points={macroPoints} /></section></div>
